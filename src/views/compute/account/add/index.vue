  ...
  <div class="app-container">
    <div>
      <el-form ref="dataForm" :rules="rules" :model="form" label-width="120px">
        ...
        <el-form-item>
          <el-button type="primary" round="round" icon="el-icon-circle-plus" @click="handleCreate">新增</el-button>
    ...
    <div>
      <el-dialog width="20%" :title="dialogTitle" :visible.sync="dialogFormVisible">
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="warning" icon="el-icon-check" :loading="confirmLoading" @click="onSubmit()">
            确认
          </el-button>
        </div>
      </el-dialog>
...
<script>
import { addApplication } from '@/api/compute'
...
export default {
  ...
  methods: {
    onReset() {
      this.form.idcCenterName = undefined
      this.form.address = undefined
      this.form.owner = undefined
